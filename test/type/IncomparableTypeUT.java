...
public class IncomparableTypeUT extends ExpressionTest {
    ...
    @Test
    public void equalityOperatorExceptionTest() throws ExpressionException, IncomparableTypeException, ParserException, UnknownSequenceException {
        runExpressionTest(INPUT_EQU, RESULT_EQU);
    }

    @Test
    public void equalityOperatorTest() throws ExpressionException, IncomparableTypeException, ParserException, UnknownSequenceException {
