...
public class PredefinedFunctionUT extends FunctionTest {
    ...
    private static final LinkedList RESULT_CONS = new LinkedList<>(Arrays.asList(wrap(4), wrap(1), wrap(2), wrap(3)));
    private static final Integer RESULT_HEAD = 1;
    private static final LinkedList RESULT_LIST = new LinkedList<>(Arrays.asList(wrap(1), wrap(2), wrap(3)));
    private static final Double RESULT_MAX = 40d;
    private static final Double RESULT_SUM = 60d;
    private static final LinkedList RESULT_TAIL = new LinkedList<>(Arrays.asList(wrap(2), wrap(3)));
    ...
    @Test
    public void consFunctionTest() throws ExpressionException, IncomparableTypeException, ParserException, UnknownSequenceException {
        runExpressionListTest(INPUT_CONS, RESULT_CONS);
    }

    @Test
    public void headFunctionTest() throws ExpressionException, IncomparableTypeException, ParserException, UnknownSequenceException {
        runExpressionTest(INPUT_HEAD, RESULT_HEAD);
    }

    @Test
    public void listFunctionTest() throws ExpressionException, IncomparableTypeException, ParserException, UnknownSequenceException {
        runExpressionListTest(INPUT_LIST, RESULT_LIST);
    }

    @Test
    public void maxFunctionTest() throws ExpressionException, IncomparableTypeException, ParserException, UnknownSequenceException {
        runExpressionTest(INPUT_MAX, RESULT_MAX);
    }

    @Test
    public void sumFunctionTest() throws ExpressionException, IncomparableTypeException, ParserException, UnknownSequenceException {
        runExpressionTest(INPUT_SUM, RESULT_SUM);
    }

    @Test
    public void tailFunctionTest() throws ExpressionException, IncomparableTypeException, ParserException, UnknownSequenceException {
