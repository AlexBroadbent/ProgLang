...
public class SimpleCalculationUT extends ExpressionTest {
    ...
    @Test
    public void simpleSubtractionTest() throws ExpressionException, UnknownSequenceException, IncomparableTypeException, ParserException {
        runExpressionTest(INPUT_SUB, RESULT_SUB);
    }

    @Test
    public void simpleMultiplicationTest() throws ExpressionException, UnknownSequenceException, IncomparableTypeException, ParserException {
        runExpressionTest(INPUT_MULTI, RESULT_MULTI);
    }

    @Test
    public void simpleDivisionTest() throws ExpressionException, UnknownSequenceException, IncomparableTypeException, ParserException {
        runExpressionTest(INPUT_DIV, RESULT_DIV);
    }

    @Test
    public void simpleConcatenationTest() throws ExpressionException, UnknownSequenceException, IncomparableTypeException, ParserException {
