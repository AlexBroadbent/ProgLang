...
public class MathOperatorUT extends ExpressionTest {
    ...
    @Test
    public void operatorSineTest() throws ExpressionException, UnknownSequenceException, IncomparableTypeException, ParserException {
        runExpressionTest(INPUT_SIN, RESULT_SIN);
    }

    @Test
    public void operatorCosineTest() throws ExpressionException, UnknownSequenceException, IncomparableTypeException, ParserException {
        runExpressionTest(INPUT_COS, RESULT_COS);
    }

    @Test
    public void operatorTangentTest() throws ExpressionException, UnknownSequenceException, IncomparableTypeException, ParserException {
        runExpressionTest(INPUT_TAN, RESULT_TAN);
    }

    @Test
    public void operatorASineTest() throws ExpressionException, UnknownSequenceException, IncomparableTypeException, ParserException {
        runExpressionTest(INPUT_ASIN, RESULT_ASIN);
    }

    @Test
    public void operatorACosineTest() throws ExpressionException, UnknownSequenceException, IncomparableTypeException, ParserException {
        runExpressionTest(INPUT_ACOS, RESULT_ACOS);
    }

    @Test
    public void operatorATangentTest() throws ExpressionException, UnknownSequenceException, IncomparableTypeException, ParserException {
        runExpressionTest(INPUT_ATAN, RESULT_ATAN);
    }

    @Test
    public void operatorPowerTest() throws ExpressionException, UnknownSequenceException, IncomparableTypeException, ParserException {
        runExpressionTest(INPUT_POW, RESULT_POW);
    }

    @Test
    public void operatorSquareRootTest() throws ExpressionException, UnknownSequenceException, IncomparableTypeException, ParserException {
        runExpressionTest(INPUT_SQR, RESULT_SQR);
    }

    @Test
    public void operatorNaturalLogTest() throws ExpressionException, UnknownSequenceException, IncomparableTypeException, ParserException {
        runExpressionTest(INPUT_NLN, RESULT_NLN);
    }

    @Test
    public void operatorLog10Test() throws ExpressionException, UnknownSequenceException, IncomparableTypeException, ParserException {
        runExpressionTest(INPUT_L10, RESULT_L10);
    }

    @Test
    public void operatorExponentialTest() throws ExpressionException, UnknownSequenceException, IncomparableTypeException, ParserException {
        runExpressionTest(INPUT_EXP, RESULT_EXP);
    }

    @Test
    public void operatorModuloTest() throws ExpressionException, UnknownSequenceException, IncomparableTypeException, ParserException {
