...
public class ConditionalOperatorUT extends ExpressionTest {
    ...
    @Test
    public void simpleConditionalOperatorTest() throws UnknownSequenceException, ExpressionException, IncomparableTypeException, ParserException {
        runExpressionTest(INPUT_SIM, RESULT_SIM);
    }

    @Test
    public void simple2ConditionalOperatorTest() throws UnknownSequenceException, ExpressionException, IncomparableTypeException, ParserException {
        runExpressionTest(INPUT_SIM_2, RESULT_SIM_2);
    }

    @Test
    public void complexConditionalOperatorTest() throws UnknownSequenceException, ExpressionException, IncomparableTypeException, ParserException {
        runExpressionTest("Complex Conditional[" + INPUT_COM + "]", INPUT_COM, RESULT_COM);
    }

    @Test
    public void complex2ConditionalOperatorTest() throws UnknownSequenceException, ExpressionException, IncomparableTypeException, ParserException {
